...
type DeepThinkingFormValues = z.infer<typeof deepThinkingFormSchema>;

const defaultValues: Partial<DeepThinkingFormValues> = {
...
export function DeepThinkingGeneratorForm({ 
  ...
  React.useEffect(() => {
    form.setValue('customOutline', customOutline);
  }, [customOutline, form]);
  ...
  const onSubmit = async (data: DeepThinkingFormValues) => {
    if (!apiKey) {
      toast({
        variant: "destructive",
    ...
    try {
      ...
      toast({
        ...
        description: "Your deep thinking content is ready to review.",
      });
    } catch (error) {
  ...
  const handleOutlineChange = (outline: string) => {
    ...
    form.setValue('customOutline', outline);
  };
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                    ...
                    Deep Thinking Generator
                  </CardTitle>
                  <CardDescription>
                    Use AI models that show their thinking process while creating content
                  </CardDescription>
                </CardHeader>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <div className="flex items-center justify-between">
                            <FormLabel>Thinking AI Model</FormLabel>
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="max-w-xs">These models explicitly show their reasoning process while generating content. This may result in longer generation times but more thoughtful outputs.</p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                          </div>
                          ...
                          >
                            ...
                            <SelectContent>
                              <div className="mb-2 px-2 py-1.5 text-sm font-semibold">Thinking Models</div>
                          ...
                          <FormDescription>
                            These models take longer to generate content as they show their thinking process
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="mt-4">
                      <CustomOutlineSection
                        outline={customOutline || form.getValues("customOutline") || ""}
            ...
            {!apiKey ? (
              ...
              <Alert>
                ...
                <AlertTitle>Deep Thinking Models</AlertTitle>
                <AlertDescription>
                  These models explicitly show their reasoning process and take longer to generate content.
                  {form.getValues('backgroundGeneration') ? 
                    ...
                    " The content will include the model's thinking steps in the final output."}
                </AlertDescription>
              </Alert>
            )}
            ...
            >
              {isGenerating ? "Generating..." : form.getValues('backgroundGeneration') ? 
                "Generate & Save to My Content" : "Generate With Visible Thinking"}
            </Button>
          </form>
        </Form>
      </TabsContent>
                    ...
                    <ReactMarkdown components={{
                      ...
                      blockquote: ({ node, ...props }) => {
                        if (props.children && typeof props.children === 'string' && 
                          ...
                          return (
                            <blockquote className="border-l-4 border-amber-500 pl-4 my-4 bg-amber-50 dark:bg-amber-950/20 p-3 rounded-r" {...props} />
                          );
                        }
                        return <blockquote className="border-l-4 border-primary/50 pl-4 italic my-4" {...props} />;
                      },
